...
public void Scrap_Activate(int client, char abilityName[255])
{
	...
	for (int i = 0; i < numBullets; i++)
		CF_FireGenericBullet(client, ang, damage, hsMult, spread, GADGETEER, Scrap_Hit, falloffStart, falloffEnd, falloffMax, pierce, TFTeam_Unassigned, GADGETEER, Scrap_CheckTarget, (TF2_GetClientTeam(client) == TFTeam_Red ? PARTICLE_SCRAP_TRACER_RED : PARTICLE_SCRAP_TRACER_BLUE), 0.0);
}
