...
- **RECOMMENDED: [TF2 Edict Limiter](https://github.com/Poggicek/tf2-edict-limiter)** - Not required to function, but TF2 was never meant to handle some of the things these characters can do, so this plugin will help prevent some of the crashes that may cause.
