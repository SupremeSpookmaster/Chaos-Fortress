...
- **RECOMMENDED: [TF2 Edict Limiter](https://github.com/sapphonie/tf2-edict-limiter)** - Not required to function, and the "vanilla" build of ***Chaos Fortress*** (vanilla meaning straight from the installation build with no changes) should never cause edict limit crashes, but it's still better to be safe than sorry. **CURRENTLY BROKEN ON LIVE BUILD.**
