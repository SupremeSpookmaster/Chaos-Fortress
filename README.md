...
## *Update Guide*
  ...
  2. Extract the zip file directly to your server's sourcemod folder, not including `data/fake_particle_system/fakeparticles.cfg` or `data/pnpc/npcs.cfg`. See step 3 to see how to handle these files.
